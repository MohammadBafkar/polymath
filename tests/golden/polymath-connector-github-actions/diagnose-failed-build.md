---
plugin: polymath-connector-github-actions
scenario: diagnose-failed-build
expect:
  invoked:
    - polymath-connector-github-actions:diagnose-ci-failure
  output_matches:
...
Use polymath-connector-github-actions:diagnose-ci-failure. The
