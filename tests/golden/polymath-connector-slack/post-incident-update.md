---
plugin: polymath-connector-slack
scenario: post-incident-update
expect:
  invoked:
    - polymath-connector-slack:post-incident-comms
  output_matches:
    - "(channel|thread_ts|chat_postMessage)"
    - "(thread|ts)"
  not_invoked:
    - polymath-connector-slack:post-async-update
timeout_seconds: 90
---
...
Use polymath-connector-slack:post-incident-comms. Incident ID:
