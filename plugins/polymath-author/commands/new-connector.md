...
Connectors must follow the Phase 4 layout (see [`docs/PLUGIN-AUTHORING.md`](../../../docs/PLUGIN-AUTHORING.md)): MCP server reference, sensitive credentials via `userConfig`, optional hooks for event-driven reactions, and a reference doc.
